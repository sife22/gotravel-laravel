...
@section('title', 'Connexion agence - GoTravel')
@section('css')
<style>
  .navbar{
...
<div class="div_connexion">
  <form action="/loginAgence" method="POST" class="form_connexion">
    @csrf
    <div>
      <h1 class="form_title">Connectez-vous
      </h1>
    </div>
    
    @if(session()->has('middleware_agence'))
        <h3 class="erreur">{{ Session()->get('middleware_agence') }}</h3>
        @endif
    <br />
    <div>
      <label>
    ...
    <div style="display: grid; justify-content:center">
      <div>
        <a href="/inscription/agence" class="btn-inscription">
          Créer un compte
        </a>
      </div>
      <div>
