...
<main>
    <div class="main__container">
      <div class="div_ajoute">
        <form action="ajouterVoyage" method="post" class="form_voyage" enctype="multipart/form-data">
            @csrf
          <div>
          ...
          <div>
            <label>
              ...
              <select name="type" value="{{ old('type') }}">
                ...
                <option value="Client" @if(old('categorie') == 'Client') selected @endif>Client</option>
                <option value="Agence" @if(old('categorie') == "Agence") selected @endif>Agence</option>
            </select>
