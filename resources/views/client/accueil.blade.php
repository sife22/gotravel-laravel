...
@section('css')
<link rel="stylesheet" href="style/clients/accueil.css">
    ...
    <div class="container py-5">
        <div class="row justify-content-center py-5">
            <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">"Explorez, découvrez, voyagez : Le monde à portée de clic!"</h1>
        ...
        <div class="row gy-5 gx-4 justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                <div class="position-relative border border-primary pt-5 pb-4 px-4">
                    ...
                    <p class="mb-0">Enregistrez-vous facilement et réservez vos offres rapidement.</p>
                </div>
            </div>
