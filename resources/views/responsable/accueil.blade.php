...
@section('title', 'Responsable Responsable')
@section('css')
<link rel="stylesheet" href="/style/reponsable/accueil.css" type="text/css" />
@endsection
@section('content')
<main>
    <div class="main__container">
      ...
      <div class="main__cards">
        ...
        <div class="card">
          ...
          <div class="card_inner">
            <p class="text-primary-p">Chiffre d'affaire prospective</p>
            <span class="font-bold text-title">{{ $chiffre }} Dh</span>
          </div>
        </div>
      </div>
